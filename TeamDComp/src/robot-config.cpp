...
motor RightDriveMotorsMotorB = motor(PORT16, ratio18_1, true);
...
motor FingerMotor = motor(PORT9, ratio18_1, false);
...
digital_out Pneumatic2 = digital_out(Brain.ThreeWirePort.A);
motor FlywheelMotorMotorA = motor(PORT10, ratio6_1, false);
motor FlywheelMotorMotorB = motor(PORT11, ratio6_1, true);
